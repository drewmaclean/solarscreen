...
public class SunriseSunsetCalculator {
    ...
    /**
     * Constructs a new <code>SunriseSunsetCalculator</code> with the given <code>Loc</code>
     * 
     * @param location
     *            <code>Loc</code> object containing the Latitude/Longitude of the Loc to compute
     ...
     * @param latitude
     * @param longitude
     *            Coordinates for the Loc to compute the sunrise/sunset for.
     * @param timeZone
     *            timezone to compute the sunrise/sunset times in.
     * @param date
     *            <code>Calendar</code> object containing the date to compute the official sunset for.
    ...
    /**
     * Returns the Loc where the sunrise/sunset is calculated for.
     * 
     * @return <code>Loc</code> object representing the Loc of the computed sunrise/sunset.
     */
