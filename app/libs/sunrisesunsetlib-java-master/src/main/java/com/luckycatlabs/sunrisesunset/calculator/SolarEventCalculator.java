...
public class SolarEventCalculator {
     ...
     *
     * @param location
     *            <code>Loc</code> of the place where the solar event should be calculated from.
     * @param timeZoneIdentifier
     *            time zone identifier of the timezone of the Loc parameter. For example,
     *            "America/New_York".
     */
     ...
     *
     * @return the longitude of the Loc of the solar event divided by 15 (deg/hour), in
    ...
    /**
     * Computes the true longitude of the sun, L in the algorithm, at the given Loc, adjusted to fit in
     * the range [0-360].
     *
     * @param meanAnomaly
